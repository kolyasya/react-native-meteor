  ...
  constructor(options) {
    ...
    this.socket.on('message:in', message => {
      if (message.msg === 'connected') {
        ...
        // Filter the message queue of subscriptions, as any outstanding subscription requests
        // will be duplicates of those generated by Meteor.js's _subscriptionsRestart() call.
        // There might be a more elegant way of doing this, by not enqueuing a { msg: "sub" } message
        // earlier in the subscription process, if a subscription is attempted when the connection
        // is offline.
        this.messageQueue.queue = this.messageQueue.queue.filter(q => q.msg !== "sub");
